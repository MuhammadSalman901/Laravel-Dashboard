<x-layout>
    <x-headerfooter.section-heading>Product Form</x-headerfooter.section-heading>
        ...
        <form method="post" action="{{ route('product.store') }}">
            ...
            <div class="space-y-12 mt-3">
                <div class="border-b border-gray-900/90 pb-12">
                    ...
                    <p class="mt-1 text-sm/6 text-gray-600">The below information will be used in creation of product.</p>
                    ...
                    <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-6">
                        <x-form.form-feild>
                            ...
                            <div class="mt-2">
                                ...
                                <x-form.form-error name="supplier_id" />
                            </div>
                        </x-form.form-feild>
                        ...
                        <x-form.form-feild>
                            ...
                            <div class="mt-2">
                                <x-form.form-input name="product_name" id="product_name" value="{{ old('product_name') }}" placeholder="PRODUCT A" />
                        ...
                        <x-form.form-feild>
                            ...
                            <div class="mt-2">
                                <x-form.form-input name="quantity" type="number" id="quantity" value="{{ old('quantity') }}" placeholder="50" />
                        ...
                        <x-form.form-feild>
                            ...
                            <div class="mt-2">
                                <x-form.form-input name="price" id="price" value="{{ old('price') }}" placeholder="$17.92" />
                        ...
                        <x-form.form-feild>
                            ...
                            <div class="mt-2">
                                <x-form.form-input name="units_in_stock" type="number" id="units_in_stock" value="{{ old('units_in_stock') }}" placeholder="20" />
                        ...
                        <x-form.form-feild>
                            ...
                            <div class="mt-2">
                                <x-form.form-input name="units_on_order" type="number" id="units_on_order" value="{{ old('units_on_order') }}" placeholder="20" />
                        ...
                        <x-form.form-feild>
                            ...
                            <div class="mt-2">
                                <x-form.form-input name="reorder_level" type="number" id="reorder_level" value="{{ old('reorder_level') }}" placeholder="20" />
                        ...
                        <x-form.form-feild>
                            ...
                            <div class="mt-2">
                                <x-form.form-input name="discontinued" type="number" id="discontinued" value="{{ old('discontinued') }}" placeholder="0 or 1" />
