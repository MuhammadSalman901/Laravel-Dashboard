<x-layout>
    <x-headerfooter.section-heading>Update Customer</x-headerfooter.section-heading>
    ...
    <x-form.form-panel>
        <form method="POST" action="{{ route('customer.update', $customers->id) }}">
                        ...
                        <x-form.form-feild>
                            ...
                            <div class="mt-2">
                                <x-form.form-input name="contact_name" id="contact_name"
                                    value="{{ old('contact_name', $customers->contact_name) }}"
                        ...
                        <x-form.form-feild>
                            ...
                            <div class="mt-2">
                                <x-form.form-input name="company_name" id="company_name"
                                    value="{{ old('company_name', $customers->company_name) }}"
                        ...
                        <x-form.form-feild>
                            ...
                            <div class="mt-2">
                                <x-form.form-input name="contact_title" id="contact_title"
                                    value="{{ old('contact_title', $customers->contact_title) }}"
                                    placeholder="CT A" />
                        ...
                        <x-form.form-feild>
                            ...
                            <div class="mt-2">
                                <x-form.form-input name="email" type="email" id="email"
                                    ...
                                    placeholder="cta.cmpa@example.com" />
            ...
            <div class="mt-6 px-6 flex items-center justify-end gap-x-6">
                ...
                <x-form.form-button>Update Customer</x-form.form-button>
            </div>
        </form>
    </x-form.form-panel>
</x-layout>