<x-layout>
    <x-headerfooter.section-heading>Update User</x-headerfooter.section-heading>
        ...
        <form method="POST" action="{{ route('user.update', $user->id) }}" enctype="multipart/form-data">
            ...
            <div class="space-y-12 px-5 mt-3">
                <div class="border-b border-gray-900/90 pb-12">
                    <h2 class="text-base/7 font-semibold text-gray-900">Edit User</h2>
                    <p class="mt-1 text-sm/6 text-gray-600">Update the user information below.</p>
                    ...
                    <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-6">
                        ...
                        <x-form.form-feild>
                            ...
                            <div class="mt-2">
                                <x-form.form-input name="title" id="title"
                        ...
                        <x-form.skill-input-field name="skills_input" :user="$user" />
                        
                        <x-form.form-feild>
                            <x-form.form-label for="experience">Experience</x-form.form-label>
                            <div class="mt-2">
                                <x-form.form-input type="number" name="experience"
                                    placeholder="10"
                        ...
                        <x-form.form-feild>
                            ...
                            <div class="mt-2">
                                <x-form.form-input type="text" name="bio"
            ...
            <div class="mt-6 px-6 flex items-center justify-end gap-x-6">
                ...
                <x-form.form-button>Update User</x-form.form-button>
            </div>
        </form>
    </x-form.form-panel>
</x-layout>