<x-layout>
    <x-headerfooter.section-heading>Supplier Form</x-headerfooter.section-heading>
        ...
        <form method="post" action="{{ route('supplier.store') }}">
            ...
            <div class="space-y-12 mt-3">
                <div class="border-b border-gray-900/90 pb-12">
                    <h2 class="text-base/7 font-semibold text-gray-900">Create a New Supplier</h2>
                    <p class="mt-1 text-sm/6 text-gray-600">The below information will be used in creation of supplier.</p>
                    ...
                    <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-6">
                        <x-form.form-feild>
                            ...
                            <div class="mt-2">
                                <x-form.form-input name="contact_name" id="contact_name" value="{{ old('contact_name') }}" placeholder="SUPPLIER A" />
